...
*/
/*--------------------------------------------------------------------------*/
#ifndef PARTICLE_LIST_MIC_SIMPLE_H
#define PARTICLE_LIST_MIC_SIMPLE_H
...
*/
/*--------------------------------------------------------------------------*/
class ParticleListMICSimple
{
public:
	__host__ __device__
	ParticleListMICSimple();
	__host__ __device__
	~ParticleListMICSimple();
	...
	*/
	...
	void copy_from(const ParticleListMICSimple* list_in);
...
#endif /* PARTICLE_LIST_MIC_SIMPLE_H */
