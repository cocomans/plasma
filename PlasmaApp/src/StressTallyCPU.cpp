...
void StressTallyCPU::tally1d1v(const realkind px,
		 const realkind vx,
		 const int ix_in,
		 const realkind scale)
{
	...
	for(int i=-1;i<2;i++)
	{
		...
		temp = vx*vx*S2_shape(xp)*vol_inv;
...
void StressTallyCPU::tally1d3v(const realkind px,
...
void StressTallyCPU::tally2d3v(const realkind px, const realkind py,
						 const realkind vx, const realkind vy, const realkind vz,
...
void StressTallyCPU::tally(const realkind px, const realkind py, const realkind pz,
		 const realkind vx, const realkind vy, const realkind vz,
