...
PhysBasedPrec::PhysBasedPrec(const Teuchos::RCP<MapManager> &map_manager,
...
PhysBasedPrec::~PhysBasedPrec()
{
}

void PhysBasedPrec::ImportParams()
{
...
// newton iterate x;
///////////////////////////////////////////////////////////////////
void PhysBasedPrec::UpdateMatrix(const Epetra_Vector &x)
{
...
// for the ML solver.
///////////////////////////////////////////////////////////////////
int PhysBasedPrec::ApplyInverse( const Epetra_MultiVector &r, Epetra_MultiVector &z) const
{
...
//////////////////////////////////////////////////////
//////////////////////////////////////////////////////
const Epetra_Comm& PhysBasedPrec::Comm () const{  return *comm;}


const Epetra_Map& PhysBasedPrec::OperatorDomainMap () const
{
  return *mapManager->PtSdMap;
}


const Epetra_Map& PhysBasedPrec::OperatorRangeMap () const
{
  return *mapManager->PtSdMap;

}

int PhysBasedPrec::SetUseTranspose(bool UseTranspose)
{
  return 1;
}

int PhysBasedPrec::Apply(const Epetra_MultiVector &X, Epetra_MultiVector &Y) const
{
  return 1;
}


double PhysBasedPrec::NormInf() const
{
  return 1;
}

const char* PhysBasedPrec::Label() const
{
  return "User Preconditioner";
}

bool PhysBasedPrec::UseTranspose() const
{
  return false;
}

bool PhysBasedPrec::HasNormInf() const
{
  return false;
}
