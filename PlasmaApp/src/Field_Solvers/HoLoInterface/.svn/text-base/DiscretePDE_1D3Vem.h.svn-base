#ifndef PDE_PROBLEM_1D3VEM_H_
#define PDE_PROBLEM_1D3VEM_H_

#include "DiscretePDE.h"

class DiscretePDE_1D3Vem : public DiscretePDE
{
 public:

    DiscretePDE_1D3Vem(const Teuchos::RCP<MapManager> &map_manager,
