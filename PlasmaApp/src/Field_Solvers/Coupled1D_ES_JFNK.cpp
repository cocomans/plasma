...
//	This is the header-file for the electro-static 1D 2 species JFNK solver
//
//========================================================================
...
//
//========================================================================
Coupled1D_ES_JFNK::~Coupled1D_ES_JFNK()
{
...
//
//========================================================================
void Coupled1D_ES_JFNK::init(PlasmaData* pDataIn,
...
void Coupled1D_ES_JFNK::solve(	PlasmaData* pData,
							FieldData* fields,
							HOMoments* moments_next_in)
{
	int nx = pData->nx;
...
realkind Coupled1D_ES_JFNK::calc_residual(	PlasmaData* pData,
